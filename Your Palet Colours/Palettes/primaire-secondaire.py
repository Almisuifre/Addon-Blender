...
C0.create_color1 = (1.0, 0.0, 0.0) 
C1.create_color2 = (0.0, 1.0, 0.0) 
C2.create_color3 = (0.0, 0.0, 1.0) 
C3.create_color4 = (1.0, 1.0, 1.0) 
C4.create_color5 = (1.0, 1.0, 1.0) 
C5.create_color6 = (1.0, 1.0, 0.0) 
C6.create_color7 = (0.0, 1.0, 1.0) 
C7.create_color8 = (1.0, 0.0, 1.0) 
C8.create_color9 = (1.0, 1.0, 1.0) 
C9.create_color10 = (0.0, 0.0, 0.0) 
